class CycleActionsController < BaseController
  before_action :get_cycle_action, only: [:edit, :update, :destroy, :toggle_completed, :add_actual_hour, :remove_actual_hour, :toggle_economic, :defer, :defer_next, :undo_defer_next, :settle, :archive, :unarchive]
  before_action :ensure_open_cycle, only: [:edit, :update, :destroy, :toggle_completed, :add_actual_hour, :remove_actual_hour, :toggle_economic, :defer, :defer_next, :settle, :archive, :unarchive]
