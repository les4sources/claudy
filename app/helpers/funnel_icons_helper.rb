...
module FunnelIconsHelper
  ICON_PATHS = {
    ...
    # Salles & cuisine pro
    hall: '<path d="M3 21h18M5.5 21V10.5m6.5 10.5V10.5m6.5 10.5V10.5M3 10.5h18L12 4 3 10.5Z"/>',
    # Camping — tente
    tent: '<path d="M2 20.5h20M12 6.5 4.5 20.5M12 6.5l7.5 14M9.3 20.5 12 14.5l2.7 6"/>',
    # Van / camping-car
    ...
    # Activités, nature
    leaf: '<path d="M11 20.5a7 7 0 0 1-1.2-13.9C15.5 5.4 17 4.9 19 2.5c1 2 2 4.2 2 8 0 5.5-4.8 10-10 10Z"/><path d="M2.5 21.5c0-3 1.9-5.4 5.1-6C10 15 12.5 13.5 13.5 12.5"/>',
    # Hamac
    hammock: '<path d="M4 5v14M20 5v14M4 10c3.5 6.5 12.5 6.5 16 0"/>',
    # Brouette de bûches incluse (epic #260, décision 6) — feu de poêle
    flame: '<path d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.048 8.287 8.287 0 0 0 9 9.6a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 4.48Z"/><path d="M12 18a3.75 3.75 0 0 0 .495-7.468 5.99 5.99 0 0 0-1.925 3.547 5.975 5.975 0 0 1-2.133-1.001A3.75 3.75 0 0 0 12 18Z"/>',
    # Carte du domaine (epic #348, phase 4)
    ...
    arrow_left: '<path d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"/>',
