...
#   config.label_class = 'text-sm font-medium text-gray-700'
#
#   # vertical forms
#   #
#   # vertical default_wrapper
#   config.wrappers :vertical_form, tag: 'div', class: 'sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5' do |b|
#     b.use :html5
#     b.use :placeholder
...
#     b.optional :min_max
#     b.optional :readonly
#     b.use :label, class: 'block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2', error_class: 'text-red-500'
#     b.use :input, class: 'block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs sm:text-sm',
#                   wrap_with: { tag: 'div', class: 'mt-1 sm:col-span-2 sm:mt-0' },
...
#   #   b.use :input, class: 'shadow-sm appearance-none border border-gray-300 rounded-md w-full mt-1 py-2 px-3 bg-white sm:text-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 leading-6 transition-colors duration-200 ease-in-out', error_class: 'border-red-500', valid_class: 'border-green-400'
#   #   b.use :full_error, wrap_with: { tag: 'p', class: 'mt-2 text-red-500 text-xs italic' }
#   #   b.use :hint, wrap_with: { tag: 'p', class: 'mt-2 text-grey-700 text-xs italic' }
#   # end
#
